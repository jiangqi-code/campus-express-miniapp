  ...
  <view class="order-page page-shell">
    ...
    <scroll-view v-show="activeTab === 'published'" scroll-y class="order-scroll"
      ...
      <view v-else class="order-list">
        <view v-for="item in publishedList" :key="getPid(item)" class="card order-card" @tap="goDetail(getPid(item))">
...
const goDetail = (id: any) => uni.navigateTo({ url: `/pages/task/detail?id=${id}` })
